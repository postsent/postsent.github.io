...
\#food hate to say this but the restaurants with more diveristy group as customers tends to be healthier based on my very sensitive stomach & skin allergy history.

# 23

\#study current capacity, at most 2 focus projects, if more, it will be side.

\#nn \#code Baidu drive gives free 2TB space, hmm.. in comparison google gives 15GB. But yes, there are many restrictions.

\#cs last time I saw "man page" is second term in first year, oh its being long.

# 24 

\#nn hmm, normally batch size 96 will slower than 128, but i change to use torch1.9 compared to 1.6/7, and probably get assigned to a different GPU.

\#event federer retired. Recall I mimic his play when I first start tennis at 2016-ish. CR7 is close, time, init.

# 25 

\#meaning have a thought again last night, conclusion so far is that before, at e.g. primary school, i dont think about these almost at all and still live in it, so deduce from that, may change the problem to: always to find a environment that foster execution and reject too much overhead meaningless thinking for any task either study or exercise. 

# 26

\#health consistency + pro science pls.

# 30 

last day of Sep - see ppl from few months ago in the study gp - oh, that nostalgia.

I click "I see fire", it plays "in the end".

whenever in doubt, i am reminded about "swim or sink"